...
define config.name = _("Loveless on Lockdown")

## The version of the game.
define config.version = "1.0"

## The name of the developer.
define gui.developer_name = "ilyilaice"

## Name of your build. This must be ASCII-only, and must not contain spaces, colons,
## or semicolons.
define build.name = "LovelessOnLockdown"

# Your website. This will be clickable via the "web" icon on the main menu
# in the lower corner.
define gui.developer_site = "https://ilyilaice.itch.io/loveless-on-lockdown"
...
define guisfx_button_hover = "audio/sfx/silence_sec.ogg"

# Sound when a button is clicked.
define guisfx_button_click = "audio/sfx/silence_sec.ogg"

# Sound when a warning pops up, like when deleting a file, etc.
define guisfx_button_warn = "audio/sfx/silence_sec.ogg"

# Music for the main menu.
define config.main_menu_music = "audio/music/romantic.ogg"
