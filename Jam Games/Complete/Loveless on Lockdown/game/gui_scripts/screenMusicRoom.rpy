...
init python:
    ...
    song_list = {"audio/music/chaotic.ogg":['Chaotic', 'humanpyramids'],
                "audio/music/romantic.ogg":['Romantic', 'humanpyramids'],
                "audio/music/offline.ogg":['Offline', 'humanpyramids'],
                "audio/music/offline_subdued.ogg":['Offline subdued', 'humanpyramids'],
                "audio/music/online.ogg":['Online', 'humanpyramids'],
                "audio/music/online_subdued.ogg":['Online subdued', 'humanpyramids'],
                }
