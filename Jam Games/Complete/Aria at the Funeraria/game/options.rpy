...
define config.name = _("Aria at the Funeraria")
...
Sprites and CGs: {a=https://twitter.com/what_an_animal}what_an_animal{/a}{p}
BGs: makigirl{p}
...
{i}Paghahandog{/i} by Hangad (Cover by {a=https://twitter.com/downstairsparts}downstairsparts{/a}){p}
{i}I Kissed a Girl{/i} by Katy Perry{p}
""")
...
define build.name = "AriaAtTheFuneraria"
...
define config.save_directory = "AriaAtTheFuneraria-1623083899"
