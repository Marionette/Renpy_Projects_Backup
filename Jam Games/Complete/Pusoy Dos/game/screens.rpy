...
style button_text is gui_text:
    ...
    insensitive_outlines [ (absolute(2), "#585858", absolute(0), absolute(0)) ]
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            imagebutton auto "gui/button/next_%s.png" action Preference("auto-forward", "toggle")
...
screen navigation(_xoffset=160):
...
screen extra_navigation(_xoffset=160):
...
screen main_menu():
    ...
    use navigation(_xoffset=160)
    add "gui/overlay/logo.png"
        ...
        fixed:
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        background "gui/button/saveslot_idle.png"
                        #selected_idle_background "gui/button/saveslot_select_idle.png"
                        #selected_hover_background "gui/button/saveslot_select_idle.png"
                        insensitive_background "gui/button/locked_screen.png"
                        hover_foreground "gui/button/saveslot_select_hover_BLOOD_STAIN_ONLY.png"
                        action FileAction(slot)

                        has vbox

                        add FileScreenshot(slot) xalign 0.5 xoffset 16 yoffset 8
...
style confirm_button:
    ...
    idle_background Frame("gui/button/confirmation_button_idle.png",25,20,25,20)
    hover_background Frame("gui/button/confirmation_button_hover.png",55,55,55,55)
    xsize 300
    ysize 100
