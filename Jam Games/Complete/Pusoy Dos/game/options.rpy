...
define config.name = _("Pusoy Dos")
...
Art: {a=https://twitter.com/applecidrdonut}applecidrdonut{/a}{p}
GUI: {a=https://twitter.com/what_an_animal}what_an_animal{/a}{p}
...
define config.main_menu_music = "audio/music/music_menu.mp3"
...
define config.save_directory = "PusoyDos-1632517446"
