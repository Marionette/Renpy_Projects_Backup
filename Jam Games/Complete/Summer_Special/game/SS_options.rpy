...
init -1 python hide:
    ...
    config.window_title = u"Summer_Special"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Summer_Special"
    config.version = "0.0"
    ...
    style.window.top_margin = -110
    # style.window.bottom_margin = 6

    ## Padding is space inside the window, where the background is
    ## drawn.

    style.window.left_padding = 126
    style.window.right_padding = 80
    style.window.top_padding = 72
    ...
    style.default.font = "assets/quicksand.otf"
    style.default.outlines = [ (absolute(1), "#482122", absolute(0), absolute(0)) ]
    style.say_label.font = "assets/PWShaded.ttf"
...
python early:
    config.save_directory = "Summer_Special-1458246636"
...
init python:
    ...
    build.directory_name = "Summer_Special-0.4"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Summer_Special"
