...
init -1 python hide:
    ...
    config.window_title = u"DetectiveGame"
...
python early:
    config.save_directory = "DetectiveGame-1406840109"
...
init python:
    ...
    build.directory_name = "DetectiveGame-0.1"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "DetectiveGame"
