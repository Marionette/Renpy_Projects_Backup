...
define MC_Name = "Caragh" ##The name of the main character, used to place them on the screen
...
screen nvl_phonetext(dialogue):
    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            if d.who == MC_Name:
                $ message_frame = "gui/game_phone/phone_send_frame.png"
            else:
                $ message_frame = "gui/game_phone/phone_received_frame.png"
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == MC_Name:
                        $ message_icon = "gui/game_phone/phone_send_icon.png"
                    else:
                        if d.who == "Bahini":
                            $ message_icon = "gui/game_phone/phone_received_bahini_icon.png"
                        else:
                          if d.who == "Nyx":
                              $ message_icon = "gui/game_phone/phone_received_nyx_icon.png"
                          else:
                              $ message_icon = "gui/game_phone/phone_received_icon.png"
...
style phoneFrame_frame:
    background Transform("gui/game_phone/phone_background.png", xcenter=0.5,yalign=0.5)
    foreground Transform("gui/game_phone/phone_foreground.png", xcenter=0.5,yalign=0.5)
