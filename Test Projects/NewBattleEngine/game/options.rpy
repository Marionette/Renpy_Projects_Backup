...
init -1 python hide:
    ...
    config.window_title = u"NewBattleEngine"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "NewBattleEngine"
    config.version = "0.0"
    
    #Changing the Default Mouse options
    #config.mouse = { }
    #config.mouse["default"] = [
    #     ("TestCursor.png", 0.0, 0.0),
    #     ("TestCursor2.png", 0.0, 0.0),
    #]
...
python early:
    config.save_directory = "NewBattleEngine-1400280986"
